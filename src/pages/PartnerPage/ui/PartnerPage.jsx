...
export function PartnerPage() {
  ...
  return (
    <div className="partner_page">
      {" "}
      <span>
        Мы про пиар. Пропиарь свою медийку с нами! Профессионально! Качественно!
        Выгодно! Что такое ProPR? Если коротко: Это платформа, в которой собраны
        медийные личности, от спортсменов, до блогеров и артистов, у каждого из
        которых вы можете приобрести разовую рекламу или даже заключить
        долгосрочный контракт.
      </span>
      <ul>
        Если подробнее: Чем полезен ProPR для клиентов?
        ...
        <li>
          ...
          поможем ее продвинуть и ProPRить.{" "}
        </li>
      </ul>
      <ul>
